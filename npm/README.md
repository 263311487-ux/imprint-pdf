...
The first run auto-installs the Python engine (PyPI → GitHub fallback), then everything runs locally. 22 built-in themes (academic / modern / minimal / ink / traditional ...), smart theme auto-recommendation, PDF/UA accessibility, and a rigorous print-quality validator (page balance, widow/orphan control, CJK typography, ink coverage, font embedding).
